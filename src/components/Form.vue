...
<template>
  <div class="l-form" id="form">
    <form class="b-form">
      <div class="b-form__title">
        <p class="b-form__title-text">F o r m</p>
        <img class="turtle" src="../img/turtle.png" alt="turtle" />
      </div>
      <div class="b-input">
        <label class="b-input__title">store <span class="red">*</span></label>
        <input
          type="text"
          class="b-input__text"
        ...
        <span class="b-input__warning" v-if="storeState">no result</span>
        <span class="b-input__warning" v-if="storeRequire">required</span>
      </div>
      <div class="b-input">
        <label class="b-input__title">name <span class="red">*</span></label>
        <input
          class="b-input__text"
          type="text"
        ...
        />
        <span class="b-input__warning" v-if="nameState">wrong format</span>
        <span class="b-input__warning" v-if="nameRequire">required</span>
      </div>
      <div class="b-input">
        <label class="b-input__title">phone <span class="red">*</span></label>
        <input
          ...
          v-model="phone"
        />
        <span class="b-input__warning" v-if="phoneState">wrong format</span>
        <span class="b-input__warning" v-if="phoneRequire">required</span>
      </div>
      <div class="b-input">
        <label class="b-input__title"
          >Amount of consumption <span class="red">*</span></label
        >
        <input
          ...
          v-model="amount"
        />
        <span class="b-input__warning" v-if="amountState">wrong format</span>
        <span class="b-input__warning" v-if="amountRequire">required</span>
      </div>
      <div class="b-input">
        <label class="b-input__title">payment <span class="red">*</span></label>
        <select
          :class="{ inputError: paymentRequire, requireError: paymentRequire }"
          class="b-input__select"
          v-model="payment"
        >
        ...
        <span class="b-input__warning" v-if="paymentRequire">required</span>
      </div>
    </form>
    <button
      :class="success"
      class="l-form__submit"
      type="submit"
      v-if="allSuccess"
